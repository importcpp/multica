-- Backing index for external_issue_link's primary key, attached in the next migration via
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS external_issue_link_pkey_uidx ON external_issue_link (id);
