-- Backing index for external_issue_sync_run's primary key, attached in the next migration via
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS external_issue_sync_run_pkey_uidx ON external_issue_sync_run (id);
