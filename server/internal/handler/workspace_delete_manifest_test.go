...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"external_issue_source":              workspaceDelete,
	"external_issue_sync_event":          workspaceDelete,
	"external_issue_sync_run":            workspaceDelete,
	"external_issue_sync_run_item":       workspaceDelete,
